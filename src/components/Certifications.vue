...
const data = [
    ...
    },    
    {
        ...
        src: '/public/images/c_sharp2.png'
    },
    {
        href:'#',
        src: '/public/images/system-analyst.png'
    },
    {
        href: '#',
        src: ''
